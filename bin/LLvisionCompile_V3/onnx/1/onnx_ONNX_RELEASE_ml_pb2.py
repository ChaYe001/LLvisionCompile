...
_TENSORANNOTATION = _descriptor.Descriptor(
  ...
  full_name='ONNX_RELEASE.TensorAnnotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor_name', full_name='ONNX_RELEASE.TensorAnnotation.tensor_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='quant_parameter_tensor_names', full_name='ONNX_RELEASE.TensorAnnotation.quant_parameter_tensor_names', index=1,
...
_GRAPHPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quantization_annotation', full_name='ONNX_RELEASE.GraphProto.quantization_annotation', index=7,
      number=14, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
TensorAnnotation = _reflection.GeneratedProtocolMessageType('TensorAnnotation', (_message.Message,), dict(
  ...
  __module__ = 'onnx.onnx_ONNX_RELEASE_ml_pb2'
  # @@protoc_insertion_point(class_scope:ONNX_RELEASE.TensorAnnotation)
  ))
